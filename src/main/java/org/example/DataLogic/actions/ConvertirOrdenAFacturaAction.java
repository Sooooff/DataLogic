...
public class ConvertirOrdenAFacturaAction extends ViewBaseAction {
    ...
    public void execute() throws Exception {
        ...
        if (empleado == null) {
            addError("El empleado seleccionado no existe.");
            return;
        }


        if (orden.getCliente() == null) {
            addError("La orden no tiene cliente asignado.");
            return;
        }
        ...
        // Copiar ítems
        for (ItemLinea item : orden.getItems()) {
            ItemLinea nuevoItem = new ItemLinea();
        ...
        addMessage("Orden #" + orden.getNumeroOrden() +
                ...
                " para el vendedor: " + empleado.getNombreCompleto());
